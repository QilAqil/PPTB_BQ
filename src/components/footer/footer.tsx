        ...
        <div className="py-12">
          ...
          >
            ...
            />
              ...
              <p className="text-muted-foreground mb-4">Fakultas Syari'ah dan Hukum</p>
              
              {/* Contact Information */}
              <div className="space-y-2 text-sm text-muted-foreground">
                <div className="flex items-start gap-2">
                  <MapPin className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Jl. KH. Hasyim Asy'ari Km. 3 Kalibeber, Mojotengah, Wonosobo, Jawa Tengah 56351</span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="h-4 w-4" />
                  <span>Telp: (0286) 321873</span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="h-4 w-4" />
                  <span>Fax: (0286) 324160</span>
                </div>
                <div className="flex items-center gap-2">
                  <Mail className="h-4 w-4" />
                  <span>Email: fsh@unsiq.ac.id</span>
                </div>
              </div>
            ...
            {/* Middle-Left Section - Related Links */}
            <div className="lg:col-span-1">
              <h3 className="font-bold text-foreground mb-4">Tautan Terkait</h3>
            ...
            {/* Middle-Right Section - Partnerships & Alumni */}
            <div className="lg:col-span-1">
              <div className="mb-6">
                <h3 className="font-bold text-foreground mb-4">Kerjasama</h3>
                <ul className="space-y-2 text-sm">
                  <li>
                    <Link href="#" className="text-muted-foreground hover:text-foreground">
                      Dengan Lembaga
              ...
              <div>
                <h3 className="font-bold text-foreground mb-4">Alumni</h3>
                <ul className="space-y-2 text-sm">
                  <li>
                    <Link href="#" className="text-muted-foreground hover:text-foreground">
                      Himpunan Alumni
